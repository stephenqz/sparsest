"""
Code based on: https://github.com/alecwangcq/GraSP
"""
...
def GraSP(net, ratio, train_dataloader, criterion, device,num_classes=10, samples_per_class=25, num_iters=1, T=200, reinit=True):
    eps = 1e-10
    keep_ratio = 1-ratio
    old_net = net
    ...
    for it in range(num_iters):
        ...
        if print_once:
            ...
            print(x.max(), x.min())
            print_once = False
        loss = criterion(outputs.squeeze(), targets[:N//2])
        # ===== debug ================
